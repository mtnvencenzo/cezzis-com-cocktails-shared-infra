...
data "azurerm_cdn_frontdoor_endpoint" "global_shared_cdn_endpoint" {
  name                = "afde-${var.sub}-${var.region}-${var.global_environment}-shared-${var.sequence}"
  profile_name        = data.azurerm_cdn_frontdoor_profile.global_shared_cdn.name
  resource_group_name = data.azurerm_resource_group.global_shared_resource_group.name
}
...
data "azurerm_key_vault" "onprem_keyvault" {
  name                = "kv-${var.sub}-${var.region}-prm-shared-${var.short_sequence}"
  resource_group_name = data.azurerm_resource_group.global_shared_resource_group.name
}
